...
\usepackage[giveninits=true, style=numeric, backend=biber]{biblatex} % Modern bibliography facilities (you may change style to alphabetic). Change to old bibtex if you insist on using that.
